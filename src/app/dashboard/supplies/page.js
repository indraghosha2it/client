...
// export default function OfficeSupplyPage() {
//   const [supplies, setSupplies] = useState([
//     { name: "", date: "", price: "", paymentMethod: "", note: "" }, // ADD note field
//   ]);
//   const [storedSupplies, setStoredSupplies] = useState([]);
//   const [loading, setLoading] = useState(false);
//   const [saving, setSaving] = useState(false);
...
//         `BDT ${supply.price.toFixed(2)}`,
//         supply.paymentMethod,
//         supply.note || "-" // ADD note to PDF
//       ]);
      
//       // Add table using autoTable
//       autoTable(doc, {
//         startY: 50,
//         head: [['Supply Name', 'Date', 'Price (BDT)', 'Payment Method', 'Note']], // ADD Note column
//         body: tableData,
//         headStyles: {
//           fillColor: [41, 128, 185],
//           textColor: 255,
...
//           2: { cellWidth: 30 },
//           3: { cellWidth: 35 },
//           4: { cellWidth: 45 } // ADD column for note
//         },
//         didDrawPage: function (data) {
//           // Footer
//           const pageCount = doc.internal.getNumberOfPages();
...
//         setSuccess(`Successfully saved ${data.data.length} supply item(s)`);
//         // Reset form
//         setSupplies([{ name: "", date: "", price: "", paymentMethod: "", note: "" }]); // RESET with note field
//         // Refresh stored supplies
//         fetchStoredSupplies();
...
//       price: supply.price.toString(),
//       paymentMethod: supply.paymentMethod,
//       note: supply.note || "" // ADD note field
//     });
//   };
...
//           price: parseFloat(editForm.price),
//           paymentMethod: editForm.paymentMethod,
//           note: editForm.note // ADD note field
//         }),
//       });
...
//           <form onSubmit={handleSubmit} className="space-y-4">
//             {/* Header Row - Desktop only - UPDATED with Note column */}
//             <div className="hidden md:grid md:grid-cols-12 gap-3 text-sm font-semibold text-gray-600 px-1">
//               <div className="col-span-3">Supply Name</div>
//               <div className="col-span-2">Price (BDT)</div>
//               <div className="col-span-2">Date</div>
//               <div className="col-span-2">Payment Method</div>
//               <div className="col-span-2">Note (Optional)</div> {/* ADD Note column */}
//               <div className="col-span-1 text-center">Action</div>
//             </div>

//             {supplies.map((supply, index) => (
//               <div key={index} className="grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-3 items-center p-3 md:p-0 md:border-0 border border-gray-200 rounded-md mb-3 md:mb-0">
//                 {/* Mobile View - Vertical Layout - UPDATED with Note field */}
//                 <div className="md:hidden space-y-3 w-full">
//                   <div className="grid grid-cols-2 gap-2">
//                     <div>
//                       <label className="block text-xs font-medium text-gray-700 mb-1">
...
//                 {/* Desktop View - Grid Layout - UPDATED with Note column */}
//                 {/* Supply Name */}
//                 <div className="hidden md:block col-span-3">
//                   <input
//                     type="text"
...
//         {/* Edit Form Section - UPDATED with Note field */}
//         {editingId && (
//           <div 
//             ref={editFormRef}
//             className="bg-white rounded-lg shadow-md p-6 mb-8 border-2 border-blue-300"
...
//         {/* Stored Supplies Table Section - UPDATED with Note column */}
//         <div className="bg-white rounded-lg shadow-md p-6">
//           <div className="flex justify-between items-center mb-6">
//             <div>
//               <h3 className="text-lg font-semibold">Stored Office Supplies</h3>
